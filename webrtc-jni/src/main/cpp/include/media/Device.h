...
namespace jni
{
	...
	{
	    /**
	    DeviceTransport и DeviceFormFactor включают пока только для работы с аудио.
	    Видео устройства не учитываются в перечислениях. М.б. когда-то добавятся сюда и для видео устройств значения
	    */
